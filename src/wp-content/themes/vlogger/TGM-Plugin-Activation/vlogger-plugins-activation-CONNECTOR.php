...
add_action( 'tgmpa_register', 'vlogger_register_required_plugins' );
...
function vlogger_register_required_plugins() {
	/*
	...
	$plugins = array(
		array(
			...
			'version'	=> '1.3.7',
			'required'  => true,
			'source'             => $repo . $folder .'t2gconnectorclient-1.3.7.zip',
		...
		array(
			...
			'version'	=> '2.0.1',
			'required'  => true,
			'source'             => $repo . $folder .'envato-market-2.0.1.zip',
			'force_activation'   => false,
			'force_deactivation' => false
		)
	);
