...
<?php } else { ?>
	...
	<p class="meta">
		...
		?>
		<time class="review-date" datetime="<?php echo esc_attr( get_comment_date( 'c' ) ); ?>"><?php echo esc_html( get_comment_date( wc_date_format() ) ); ?></time>
		<div class="review-author"><h5><?php comment_author(); ?></h5></div>
	</p>
