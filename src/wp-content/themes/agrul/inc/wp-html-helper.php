...
// image default alt
if( !function_exists( 'agrul_img_default_alt' ) ){
	function agrul_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'agrul_img_tag' ) ){
	function agrul_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = agrul_img_default_alt( $site_name );
		}
...
// Anchor Tag
if( !function_exists( 'agrul_anchor_tag' ) ){
	function agrul_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'agrul_heading_tag' ) ){
	function agrul_heading_tag( array $args ){

		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => __( 'Write Something', 'agrul' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'data-animate'=> '',
			'data-delay'  => '',
...
// Paragraph Tag
if( !function_exists( 'agrul_paragraph_tag' ) ){
	function agrul_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'agrul_span_tag' ) ){
	function agrul_span_tag( array $args ){
