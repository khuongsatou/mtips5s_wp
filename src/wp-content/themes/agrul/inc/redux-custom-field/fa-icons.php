...
// the opt_name is set to agrul_opt.  Please replace it if change your opt_name name.
add_action( 'redux/page/agrul_opt/enqueue', 'agrul_faIconFont' );
function agrul_faIconFont() {
	
  //  Font awesome enqueue
  wp_enqueue_style( 'font-awesome', AGRUL_DIR_CSS_URI.'font-awesome.min.css', array(), '4.7.0', 'all' );
  
  // Redux admin css enqueue
  wp_enqueue_style( 'agrul-redux-admin', AGRUL_DIR_URI.'inc/redux-custom-field/assets/agrul.redux.admin.css', array(), '1.0' );
  
  // Redux admin js enqueue
  wp_enqueue_script( 'agrul-redux-admin', AGRUL_DIR_URI.'inc/redux-custom-field/assets/agrul.redux.admin.js', array( 'jquery' ), '1.0', true );
