...
if ( ! function_exists( 'wd_woocommerce_get_css' ) ) {
	add_filter( 'wd_filter_get_css', 'wd_woocommerce_get_css', 10, 2 );
	function wd_woocommerce_get_css( $css, $args ) {
...
$fdir = wd_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
    require_once $fdir;
}
