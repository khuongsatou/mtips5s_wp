...
Please install and activate it before starting to use the theme WD.
...
Theme documentation is available on https://wd.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in WD is Fontello.
