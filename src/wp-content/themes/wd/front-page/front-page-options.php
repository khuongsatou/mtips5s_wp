...
if ( ! function_exists( 'wd_front_page_add_sidebars' ) ) {
	add_action( 'after_setup_theme', 'wd_front_page_add_sidebars', 3 );
	function wd_front_page_add_sidebars() {
		if ( wd_get_theme_setting( 'allow_front_page_builder', true ) ) {
			add_filter( 'wd_filter_list_sidebars', 'wd_front_page_sidebars' );
		}
	}
}
...
// Theme init priorities:
// 3 - add/remove Theme Options elements
if ( ! function_exists( 'wd_front_page_setup3' ) ) {
	add_action( 'after_setup_theme', 'wd_front_page_setup3', 3 );
	function wd_front_page_setup3() {
		if ( wd_get_theme_setting( 'allow_front_page_builder', true ) ) {
			wd_storage_set_array_before(
				'options', 'blog', apply_filters(
					'wd_filter_front_page_options', array(

						// 'Front Page Sections'
						'front_page'              => array(
							'title'      => esc_html__( 'Front Page Builder', 'wd' ),
							'desc'       => wp_kses_data( __( 'More fine tuning component display Front Page (view and menu position, presence and position of the sidebar, header and footer, etc.) you can produce in the section "Page Options" when editing a page, selected as Front Page', 'wd' ) ),
							'priority'   => 65,
						...
						'front_page_general_info' => array(
							'title' => esc_html__( 'General settings for Front Page Builder', 'wd' ),
							'desc'  => '',
							'type'  => 'info',
						),
						'front_page_enabled'      => array(
							'title' => esc_html__( 'Enable Front Page builder', 'wd' ),
							'desc'  => wp_kses_data( __( 'If Front Page Builder is off - native page content will be shown', 'wd' ) ),
							'std'   => 0,
							'type'  => 'switch',
						),
						'front_page_sections'     => array(
							'title'      => esc_html__( 'Sections order', 'wd' ),
							'desc'       => wp_kses_data( __( 'Drag and drop sections below to set up their order on the Front Page. You can also enable / disable any section.', 'wd' ) ),
							'dependency' => array(
						...
						'front_page_bg_image'     => array(
							...
							'desc'       => wp_kses_data( __( 'Select or upload background image for whole Front page', 'wd' ) ),
							'refresh'    => false,
							'dependency' => array(
								'front_page_enabled' => array( 1 ),
							),
							'std'        => WD_THEME_FREE ? wd_get_file_url( 'front-page/images/bg.jpg' ) : '',
							'type'       => 'image',
						),
					)
				)
...
// Close panel
if ( ! function_exists( 'wd_front_page_options_close' ) ) {
	add_filter( 'wd_filter_front_page_options', 'wd_front_page_options_close', 20 );
	function wd_front_page_options_close( $options ) {
...
if ( ! function_exists( 'wd_front_page_options_title' ) ) {
	add_filter( 'wd_filter_front_page_options', 'wd_front_page_options_title' );
	function wd_front_page_options_title( $options ) {
		...
		$options                                   = array_merge(
			$options, array(
				...
				'front_page_title_slider_info'     => array(
					'title' => esc_html__( 'Slider', 'wd' ),
					'desc'  => '',
					'type'  => 'info',
				),
				'front_page_title_shortcode'       => array(
					'title'     => esc_html__( 'Slider Shortcode', 'wd' ),
					'desc'      => wp_kses_data( __( 'Paste a shortcode generated by any slider plugin. The slider will be used instead of the section title, description and buttons.', 'wd' ) ),
					'translate' => true,
				...
				'front_page_title_caption'         => array(
					...
					'std'        => wp_kses_data( __( 'Section with Big title', 'wd' ) ),
					'sanitize'   => 'wp_kses_post',
					'dependency' => array(
						'front_page_title_shortcode' => array( 'is_empty' ),
					),
				...
				'front_page_title_description'     => array(
					...
					'std'        => wp_kses_data( __( 'This text can be changed in the section "Title"', 'wd' ) ),
					'sanitize'   => 'wp_kses_post',
					'dependency' => array(
						'front_page_title_shortcode' => array( 'is_empty' ),
					),
				...
				'front_page_title_button1_link'    => array(
					'title'           => esc_html__( 'Button1 link', 'wd' ),
					'desc'            => '',
				...
				'front_page_title_button1_caption' => array(
					'title'      => esc_html__( 'Button1 caption', 'wd' ),
					'desc'       => '',
					'translate'  => true,
					'dependency' => array(
					...
					'refresh'    => false,
					'std'        => wp_kses_data( __( 'Customize Button 1', 'wd' ) ),
					'type'       => 'text',
				),
				'front_page_title_button2_link'    => array(
					'title'           => esc_html__( 'Button2 link', 'wd' ),
					'desc'            => '',
				...
				'front_page_title_button2_caption' => array(
					'title'      => esc_html__( 'Button2 caption', 'wd' ),
					'desc'       => '',
					'translate'  => true,
					'dependency' => array(
					...
					'refresh'    => false,
					'std'        => wp_kses_data( __( 'Customize Button 2', 'wd' ) ),
					'type'       => 'text',
				),
				...
				'front_page_title_scheme'          => array(
					...
					'std'     => WD_THEME_FREE ? 'dark' : 'inherit',
					'options' => array(),
					'refresh' => false,
					'type'    => 'radio',
				),
				'front_page_title_bg_image'        => array(
					...
					'refresh_wrapper' => true,
					'std'             => WD_THEME_FREE ? wd_get_file_url( 'front-page/images/bg-title.jpg' ) : '',
					'type'            => 'image',
				),
				...
				'front_page_title_bg_mask'         => array(
					...
					'desc'    => wp_kses_data( __( 'Use Background color as section mask with specified opacity. If 0 - mask is not being used', 'wd' ) ),
					'max'     => 1,
					'step'    => 0.1,
					'std'     => WD_THEME_FREE ? 0.5 : 1,
					'refresh' => false,
					'type'    => 'slider',
				),
				'front_page_title_anchor_info'     => array(
					'title' => esc_html__( 'Anchor', 'wd' ),
					'desc'  => wp_kses_data( __( 'You can select an icon and/or specify a text to create an anchor for this section to display it in the side menu (if selected in the section "Header - Menu").', 'wd' ) )
								. '<br>'
								. wp_kses_data( __( 'Attention! Anchors are available only if ThemeREX Addons plugin is installed and activated!', 'wd' ) ),
					'type'  => 'info',
				),
...
if ( ! function_exists( 'wd_front_page_options_features' ) ) {
	add_filter( 'wd_filter_front_page_options', 'wd_front_page_options_features' );
	function wd_front_page_options_features( $options ) {
		$options['front_page_sections']['std']    .= ( ! empty( $options['front_page_sections']['std'] ) ? '|' : '' ) . 'features=1';
		$options['front_page_sections']['options'] = array_merge(
			$options['front_page_sections']['options'],
			array(
				'features' => esc_html__( 'Features', 'wd' ),
			)
		);
		$options                                   = array_merge(
			$options, array(
				...
				'front_page_features_caption'      => array(
					...
					'std'       => wp_kses_data( __( 'Why our service is the best', 'wd' ) ),
					'priority'  => -80,
					'type'      => 'text',
				),
				'front_page_features_description'  => array(
					...
					'std'       => wp_kses_data( __( 'This text can be changed in the section "Features"', 'wd' ) ),
					'priority'  => -70,
					'type'      => 'textarea',
				),
				'front_page_features_widgets_info' => array(
					'title'    => esc_html__( 'Widgets', 'wd' ),
					'desc'     => wp_kses_data( __( 'You can set up widgets for this section in "Appearance - Customize" or "Appearance - Widgets" tabs.', 'wd' ) )
								. '<br>'
								. wp_kses_data( __( 'Insert your preferred widget to display services here. You can also select any other widget, thus changing the purpose of this section', 'wd' ) ),
					'priority' => -60,
					'type'     => 'info',
				),
...
if ( ! function_exists( 'wd_front_page_options_about' ) ) {
	add_filter( 'wd_filter_front_page_options', 'wd_front_page_options_about' );
	function wd_front_page_options_about( $options ) {
		$options['front_page_sections']['std']    .= ( ! empty( $options['front_page_sections']['std'] ) ? '|' : '' ) . 'about=1';
		$options['front_page_sections']['options'] = array_merge(
			$options['front_page_sections']['options'],
			array(
				'about' => esc_html__( 'About Us', 'wd' ),
			)
		);
		$options                                   = array_merge(
			$options, array(
				...
				'front_page_about_caption'      => array(
					...
					'std'       => wp_kses_data( __( 'About Us', 'wd' ) ),
					'type'      => 'text',
				),
				'front_page_about_description'  => array(
					...
					'std'       => wp_kses_data( __( 'This text can be changed in the section "About"', 'wd' ) ),
					'type'      => 'textarea',
				),
				'front_page_about_content_info' => array(
					'title' => esc_html__( 'Content', 'wd' ),
					'desc'  => '',
					'type'  => 'info',
				),
				'front_page_about_content'      => array(
					'title'     => esc_html__( 'Content', 'wd' ),
					'desc'      => wp_kses_data( __( 'The arbitrary content of the current section.', 'wd' ) )
								. '<br>'
								. wp_kses_data(
									__( 'Attention! You can use %%CONTENT%% to insert instead the content of the page, selected as the Front Page in the menu "Settings - Reading" or in the "Customize - Static Front Page"', 'wd' )
								),
					'translate' => true,
...
if ( ! function_exists( 'wd_front_page_options_team' ) ) {
	add_filter( 'wd_filter_front_page_options', 'wd_front_page_options_team' );
	function wd_front_page_options_team( $options ) {
		$options['front_page_sections']['std']    .= ( ! empty( $options['front_page_sections']['std'] ) ? '|' : '' ) . 'team=1';
		$options['front_page_sections']['options'] = array_merge(
			$options['front_page_sections']['options'],
			array(
				'team' => esc_html__( 'Our Team', 'wd' ),
			)
		);
		$options                                   = array_merge(
			$options, array(
				...
				'sidebar-widgets-front_page_team_widgets' => array(
					'title'    => esc_html__( 'Team members', 'wd' ),
					'desc'     => '',
					'priority' => 50,
					'type'     => 'section',
				),
				...
				'front_page_team_caption'                 => array(
					...
					'std'       => wp_kses_data( __( 'Meet our team', 'wd' ) ),
					'priority'  => -80,
					'type'      => 'text',
				),
				'front_page_team_description'             => array(
					...
					'std'       => wp_kses_data( __( 'This text can be changed in the section "Team members"', 'wd' ) ),
					'priority'  => -70,
					'type'      => 'textarea',
				),
				'front_page_team_widgets_info'            => array(
					...
					'desc'     => wp_kses_data( __( 'You can set up widgets for this section in "Appearance - Customize" or "Appearance - Widgets" tabs.', 'wd' ) )
								. '<br>'
								. wp_kses_data( __( 'Insert your preferred widget to display team members here. You can also select any other widget, thus changing the purpose of this section', 'wd' ) ),
					'priority' => -60,
					'type'     => 'info',
				),
				...
				'front_page_team_bg_image'                => array(
					...
					'refresh_wrapper' => true,
					'std'             => WD_THEME_FREE ? wd_get_file_url( 'front-page/images/bg-team.jpg' ) : '',
					'type'            => 'image',
				),
...
if ( ! function_exists( 'wd_front_page_options_testimonials' ) ) {
	add_filter( 'wd_filter_front_page_options', 'wd_front_page_options_testimonials' );
	function wd_front_page_options_testimonials( $options ) {
		$options['front_page_sections']['std']    .= ( ! empty( $options['front_page_sections']['std'] ) ? '|' : '' ) . 'testimonials=1';
		$options['front_page_sections']['options'] = array_merge(
			$options['front_page_sections']['options'],
			array(
				'testimonials' => esc_html__( 'Testimonials', 'wd' ),
			)
		);
		$options                                   = array_merge(
			$options, array(
				...
				'front_page_testimonials_caption'      => array(
					...
					'std'       => wp_kses_data( __( 'What our clients say', 'wd' ) ),
					'priority'  => -80,
					'type'      => 'text',
				),
				'front_page_testimonials_description'  => array(
					...
					'std'       => wp_kses_data( __( 'This text can be changed in the section "Testimonials"', 'wd' ) ),
					'priority'  => -70,
					'type'      => 'textarea',
				),
				'front_page_testimonials_widgets_info' => array(
					...
					'desc'     => wp_kses_data( __( 'You can set up widgets for this section in "Appearance - Customize" or "Appearance - Widgets" tabs.', 'wd' ) )
								. '<br>'
								. wp_kses_data( __( 'Insert your preferred widget to display testimonials here. You can also select any other widget, thus changing the purpose of this section', 'wd' ) ),
					'priority' => -60,
					'type'     => 'info',
				),
...
if ( ! function_exists( 'wd_front_page_options_blog' ) ) {
	add_filter( 'wd_filter_front_page_options', 'wd_front_page_options_blog' );
	function wd_front_page_options_blog( $options ) {
		$options['front_page_sections']['std']    .= ( ! empty( $options['front_page_sections']['std'] ) ? '|' : '' ) . 'blog=1';
		$options['front_page_sections']['options'] = array_merge(
			$options['front_page_sections']['options'],
			array(
				'blog' => esc_html__( 'Latest posts', 'wd' ),
			)
		);
		$options                                   = array_merge(
			$options, array(
				...
				'sidebar-widgets-front_page_blog_widgets' => array(
					'title'    => esc_html__( 'Latest posts', 'wd' ),
					'desc'     => '',
					'priority' => 70,
					'type'     => 'section',
				),
				...
				'front_page_blog_caption'                 => array(
					...
					'std'       => wp_kses_data( __( 'Latest posts', 'wd' ) ),
					'priority'  => -80,
					'type'      => 'text',
				),
				'front_page_blog_description'             => array(
					...
					'std'       => wp_kses_data( __( 'This text can be changed in the section "Latest posts"', 'wd' ) ),
					'priority'  => -70,
					'type'      => 'textarea',
				),
				'front_page_blog_widgets_info'            => array(
					...
					'desc'     => wp_kses_data( __( 'You can set up widgets for this section in "Appearance - Customize" or "Appearance - Widgets" tabs.', 'wd' ) )
								. '<br>'
								. wp_kses_data( __( 'Insert your preferred widget to display latest posts here. You can also select any other widget, thus changing the purpose of this section', 'wd' ) ),
					'priority' => -60,
					'type'     => 'info',
				),
...
if ( ! function_exists( 'wd_front_page_options_subscribe' ) ) {
	add_filter( 'wd_filter_front_page_options', 'wd_front_page_options_subscribe' );
	function wd_front_page_options_subscribe( $options ) {
		$options['front_page_sections']['std']    .= ( ! empty( $options['front_page_sections']['std'] ) ? '|' : '' ) . 'subscribe=1';
		$options['front_page_sections']['options'] = array_merge(
			$options['front_page_sections']['options'],
			array(
				'subscribe' => esc_html__( 'Subscribe', 'wd' ),
			)
		);
		$options                                   = array_merge(
			$options, array(
				...
				'front_page_subscribe_caption'        => array(
					...
					'std'       => wp_kses_data( __( 'Subscribe to our Newsletter', 'wd' ) ),
					'type'      => 'text',
				),
				'front_page_subscribe_description'    => array(
					...
					'std'       => wp_kses_data( __( 'This text can be changed in the section "Subscribe"', 'wd' ) ),
					'type'      => 'textarea',
				),
				'front_page_subscribe_shortcode_info' => array(
					'title' => esc_html__( 'Shortcode', 'wd' ),
					'desc'  => '',
					'type'  => 'info',
				),
				'front_page_subscribe_shortcode'      => array(
					'title'     => esc_html__( 'Shortcode to insert Subscribe form', 'wd' ),
					'desc'      => wp_kses_data( __( 'Paste shortcode, generated with any subscribe plugin (for example, MailChimp)', 'wd' ) ),
					'translate' => true,
				...
				'front_page_subscribe_bg_image'       => array(
					...
					'refresh_wrapper' => true,
					'std'             => WD_THEME_FREE ? wd_get_file_url( 'front-page/images/bg-subscribe.jpg' ) : '',
					'type'            => 'image',
				),
...
if ( ! function_exists( 'wd_front_page_options_googlemap' ) ) {
	if ( ! WD_THEME_FREE ) {
		add_filter( 'wd_filter_front_page_options', 'wd_front_page_options_googlemap' );
	}
	function wd_front_page_options_googlemap( $options ) {
		$options['front_page_sections']['std']    .= ( ! empty( $options['front_page_sections']['std'] ) ? '|' : '' ) . 'googlemap=1';
		$options['front_page_sections']['options'] = array_merge(
			$options['front_page_sections']['options'],
			array(
				'googlemap' => esc_html__( 'Google map', 'wd' ),
			)
		);
		$options                                   = array_merge(
			$options, array(
				...
				'sidebar-widgets-front_page_googlemap_widgets' => array(
					'title'    => esc_html__( 'Google map', 'wd' ),
					'desc'     => '',
					'priority' => 90,
					'type'     => 'section',
				),
				...
				'front_page_googlemap_layout'       => array(
					'title'           => esc_html__( 'Layout', 'wd' ),
					'desc'            => wp_kses_data( __( 'Select layout of this section', 'wd' ) ),
					'std'             => 'fullwidth',
					'options'         => array(
						'fullwidth' => esc_html__( 'Fullwidth', 'wd' ),
						'boxed'     => esc_html__( 'Boxed', 'wd' ),
						'columns'   => esc_html__( '2 columns', 'wd' ),
					),
				...
				'front_page_googlemap_caption'      => array(
					...
					'std'       => wp_kses_data( __( 'Google map', 'wd' ) ),
					'priority'  => -80,
					'type'      => 'text',
				),
				'front_page_googlemap_description'  => array(
					...
					'std'       => wp_kses_data( __( 'This text can be changed in the section "Google map"', 'wd' ) ),
					'priority'  => -70,
					'type'      => 'textarea',
				),
				'front_page_googlemap_content'      => array(
					'title'     => esc_html__( 'Content', 'wd' ),
					'desc'      => wp_kses_data( __( 'Any text at the left side of the map', 'wd' ) ),
					'translate' => true,
				...
				'front_page_googlemap_widgets_info' => array(
					...
					'desc'     => wp_kses_data( __( 'You can set up widgets for this section in "Appearance - Customize" or "Appearance - Widgets" tabs.', 'wd' ) )
								. '<br>'
								. wp_kses_data( __( 'Insert your preferred widget to display the map with the location of your choice here. You can also select any other widget, thus changing the purpose of this section', 'wd' ) ),
					'priority' => -60,
					'type'     => 'info',
				),
				...
				'front_page_googlemap_bg_image'     => array(
					...
					'refresh'         => '.front_page_section_googlemap',
					'refresh_wrapper' => true,
					'std'             => WD_THEME_FREE ? wd_get_file_url( 'front-page/images/bg-googlemap.jpg' ) : '',
					'type'            => 'image',
				),
...
if ( ! function_exists( 'wd_front_page_options_contacts' ) ) {
	add_filter( 'wd_filter_front_page_options', 'wd_front_page_options_contacts' );
	function wd_front_page_options_contacts( $options ) {
		$options['front_page_sections']['std']    .= ( ! empty( $options['front_page_sections']['std'] ) ? '|' : '' ) . 'contacts=1';
		$options['front_page_sections']['options'] = array_merge(
			$options['front_page_sections']['options'],
			array(
				'contacts' => esc_html__( 'Contact Us', 'wd' ),
			)
		);
		$options                                   = array_merge(
			$options, array(
				...
				'sidebar-widgets-front_page_contacts_widgets' => array(
					'title'    => esc_html__( 'Contact Us', 'wd' ),
					'desc'     => '',
					'priority' => 100,
					'type'     => 'section',
				),
				...
				'front_page_contacts_caption'        => array(
					...
					'std'       => wp_kses_data( __( 'Contact Us', 'wd' ) ),
					'type'      => 'text',
				),
				'front_page_contacts_description'    => array(
					...
					'std'       => wp_kses_data( __( 'This text can be changed in the section "Contact Us"', 'wd' ) ),
					'type'      => 'textarea',
				),
				'front_page_contacts_content'        => array(
					'title'   => esc_html__( 'Content', 'wd' ),
					'desc'    => wp_kses_data( __( 'Any text at the left side of the form', 'wd' ) ),
					'refresh' => false, // To refresh part of the page: '.front_page_section_contacts .front_page_section_contacts_content',
					'std'     => wp_kses( __( '<h5><span class="icon-home-2"> </span>Find us at the office:</h5><p>500, Lorem Street,<br />Chicago, IL, 55030<br />Mon - Fri, 09:00 - 18:00</p><h5> <span class="icon-mobile-light"> </span>Give us a call:</h5><p>Michael Jordan<br />+40 (123) 456-78-90<br />Mon - Fri, 08:00 - 22:00</p>', 'wd' ), 'wd_kses_content' ),
					'type'    => 'text_editor',
				),
				...
				'front_page_contacts_shortcode'      => array(
					'title'     => esc_html__( 'Shortcode with contact form', 'wd' ),
					'desc'      => wp_kses_data( __( 'Paste shortcode, generated with any form plugin (for example, Contacts Form 7). You can also paste any other shortcodes, changing thus the purpose of this section', 'wd' ) ),
					'translate' => true,
...
if ( ! function_exists( 'wd_front_page_options_add_active_callback' ) ) {
	add_filter( 'wd_filter_front_page_options', 'wd_front_page_options_add_active_callback', 1000 );
	function wd_front_page_options_add_active_callback( $options ) {
		foreach ( $options as $k => $v ) {
			if ( substr( $k, 0, 11 ) == 'front_page_' ) {
				$options[ $k ]['active_callback'] = 'wd_front_page_check';
			}
		}
		return $options;
	}
...
if ( ! function_exists( 'wd_front_page_check' ) ) {
	function wd_front_page_check( $control = null ) {
...
//------------------------------------------------------------------------
if ( ! function_exists( 'wd_front_page_sidebars' ) ) {
	//Handler of the add_filter( 'wd_filter_list_sidebars', 'wd_front_page_sidebars' );
	function wd_front_page_sidebars( $list = array() ) {
		$list['front_page_features_widgets']     = array(
			'name'               => wp_kses_data( __( 'Front Page section "Features"', 'wd' ) ),
			'description'        => wp_kses_data( __( 'Widgets to be shown only in the section "Features" on the front page', 'wd' ) ),
			'front_page_section' => true,
		);
		$list['front_page_team_widgets']         = array(
			'name'               => wp_kses_data( __( 'Front Page section "Team members"', 'wd' ) ),
			'description'        => wp_kses_data( __( 'Widgets to be shown only in the section "Team members" on the front page', 'wd' ) ),
			'front_page_section' => true,
		);
		$list['front_page_testimonials_widgets'] = array(
			'name'               => wp_kses_data( __( 'Front Page section "Testimonials"', 'wd' ) ),
			'description'        => wp_kses_data( __( 'Widgets to be shown only in the section "Testimonials" on the front page', 'wd' ) ),
			'front_page_section' => true,
		);
		$list['front_page_blog_widgets']         = array(
			'name'               => wp_kses_data( __( 'Front Page section "Latest Posts"', 'wd' ) ),
			'description'        => wp_kses_data( __( 'Widgets to be shown only in the section "Latest Posts" on the front page', 'wd' ) ),
			'front_page_section' => true,
		);
		if ( ! WD_THEME_FREE ) {
			$list['front_page_googlemap_widgets'] = array(
				'name'               => wp_kses_data( __( 'Front Page section "Google map"', 'wd' ) ),
				'description'        => wp_kses_data( __( 'Widgets to be shown only in the section "Google map" on the front page', 'wd' ) ),
				'front_page_section' => true,
			);
		}
		return $list;
...
if ( ! function_exists( 'wd_customizer_partial_refresh_section' ) ) {
	function wd_customizer_partial_refresh_section( $section ) {
		ob_start();
		get_template_part( apply_filters( 'wd_filter_get_template_part', "front-page/section-" . sanitize_file_name( $section ) ) );
		$output = ob_get_contents();
		ob_end_clean();
		return wd_customizer_partial_refresh_add_init_script( $output, $section );
	}
}


// Add init script to the section's html output
if ( ! function_exists( 'wd_customizer_partial_refresh_add_init_script' ) ) {
	function wd_customizer_partial_refresh_add_init_script( $output, $section ) {
		return sprintf(
			"%1$s<%2$s>
						setTimeout(function() {
...
// Button1 link
if ( ! function_exists( 'wd_customizer_partial_refresh_front_page_title_button1_link' ) ) {
	function wd_customizer_partial_refresh_front_page_title_button1_link() {
		return wd_get_theme_option( 'front_page_title_button1_link' ) != ''
				? '<a href="' . esc_url( wd_get_theme_option( 'front_page_title_button1_link' ) ) . '" class="theme_button front_page_section_button front_page_section_title_button1">'
					. esc_html( wd_get_theme_option( 'front_page_title_button1_caption' ) )
					. '</a>'
				: '';
	}
}
...
// Button2 link
if ( ! function_exists( 'wd_customizer_partial_refresh_front_page_title_button2_link' ) ) {
	function wd_customizer_partial_refresh_front_page_title_button2_link() {
		return wd_get_theme_option( 'front_page_title_button2_link' ) != ''
				? '<a href="' . esc_url( wd_get_theme_option( 'front_page_title_button2_link' ) ) . '" class="theme_button color_style_link2 front_page_section_button front_page_section_title_button2">'
					. esc_html( wd_get_theme_option( 'front_page_title_button2_caption' ) )
					. '</a>'
				: '';
	}
}
...
// Background image
if ( ! function_exists( 'wd_customizer_partial_refresh_front_page_title_bg_image' ) ) {
	function wd_customizer_partial_refresh_front_page_title_bg_image() {
		return wd_customizer_partial_refresh_section( 'title' );
	}
}
...
// Background image
if ( ! function_exists( 'wd_customizer_partial_refresh_front_page_about_bg_image' ) ) {
	function wd_customizer_partial_refresh_front_page_about_bg_image() {
		return wd_customizer_partial_refresh_section( 'about' );
	}
}
...
// Background image
if ( ! function_exists( 'wd_customizer_partial_refresh_front_page_features_bg_image' ) ) {
	function wd_customizer_partial_refresh_front_page_features_bg_image() {
		return wd_customizer_partial_refresh_section( 'features' );
	}
}
...
// Background image
if ( ! function_exists( 'wd_customizer_partial_refresh_front_page_team_bg_image' ) ) {
	function wd_customizer_partial_refresh_front_page_team_bg_image() {
		return wd_customizer_partial_refresh_section( 'team' );
	}
}
...
// Background image
if ( ! function_exists( 'wd_customizer_partial_refresh_front_page_testimonials_bg_image' ) ) {
	function wd_customizer_partial_refresh_front_page_testimonials_bg_image() {
		return wd_customizer_partial_refresh_section( 'testimonials' );
	}
}
...
// Background image
if ( ! function_exists( 'wd_customizer_partial_refresh_front_page_blog_bg_image' ) ) {
	function wd_customizer_partial_refresh_front_page_blog_bg_image() {
		return wd_customizer_partial_refresh_section( 'blog' );
	}
}
...
// Shortcode changed
if ( ! function_exists( 'wd_customizer_partial_refresh_front_page_subscribe_shortcode' ) ) {
	function wd_customizer_partial_refresh_front_page_subscribe_shortcode() {
		$wd_sc = wd_get_theme_option( 'front_page_subscribe_shortcode' );
		return ! empty( $wd_sc ) ? do_shortcode( $wd_sc ) : '';
	}
}

// Background image
if ( ! function_exists( 'wd_customizer_partial_refresh_front_page_subscribe_bg_image' ) ) {
	function wd_customizer_partial_refresh_front_page_subscribe_bg_image() {
		return wd_customizer_partial_refresh_section( 'subscribe' );
	}
}
...
// Layout
if ( ! function_exists( 'wd_customizer_partial_refresh_front_page_googlemap_layout' ) ) {
	function wd_customizer_partial_refresh_front_page_googlemap_layout() {
		return wd_customizer_partial_refresh_section( 'googlemap' );
	}
}

// Background image
if ( ! function_exists( 'wd_customizer_partial_refresh_front_page_googlemap_bg_image' ) ) {
	function wd_customizer_partial_refresh_front_page_googlemap_bg_image() {
		return wd_customizer_partial_refresh_section( 'googlemap' );
	}
}
...
// Layout
if ( ! function_exists( 'wd_customizer_partial_refresh_front_page_contacts_layout' ) ) {
	function wd_customizer_partial_refresh_front_page_contacts_layout() {
		return wd_customizer_partial_refresh_section( 'contacts' );
	}
}

// Shortcode changed
if ( ! function_exists( 'wd_customizer_partial_refresh_front_page_contacts_shortcode' ) ) {
	function wd_customizer_partial_refresh_front_page_contacts_shortcode() {
...
// Background image
if ( ! function_exists( 'wd_customizer_partial_refresh_front_page_contacts_bg_image' ) ) {
	function wd_customizer_partial_refresh_front_page_contacts_bg_image() {
		return wd_customizer_partial_refresh_section( 'contacts' );
	}
}
...
// Background image
if ( ! function_exists( 'wd_customizer_partial_refresh_front_page_woocommerce_bg_image' ) ) {
	function wd_customizer_partial_refresh_front_page_woocommerce_bg_image() {
		return wd_customizer_partial_refresh_section( 'woocommerce' );
	}
}
...
if ( !function_exists( 'wd_front_page_frontend_scripts' ) ) {
	add_action( 'wp_enqueue_scripts', 'wd_front_page_frontend_scripts', 1100 );
	function wd_front_page_frontend_scripts() {
		if ( wd_get_theme_setting( 'allow_front_page_builder', true )
			&& is_front_page()
			&& ! is_home()
			...
			$wd_url = wd_get_file_url( 'front-page/front-page.css' );
			if ( '' != $wd_url ) {
				wp_enqueue_style( 'wd-front-page',  $wd_url, array(), null );
			}
			$wd_url = wd_get_file_url( 'front-page/front-page-responsive.css' );
			if ( '' != $wd_url ) {
				wp_enqueue_style( 'wd-front-page-responsive',  $wd_url, array(), null, wd_media_for_load_css_responsive( 'front-page' ) );
			}
		}
	}
}
