...
//					window.trx_addons_elementor_templates_library.modal.getElements( 'header' ).remove(),
		...
		function updateItems( tab ) {
			var html = '';
			var items = [], column = 0, columns = getComputedStyle( jQuery( '#trx_addons_elementor_templates_library_modal').get(0) ).getPropertyValue('--trx-addons-elementor-templates-library-columns');
